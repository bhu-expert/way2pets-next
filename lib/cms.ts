...
export const resources: Record<string, ResourceConfig> = {
  ...
  pets: {
    ...
    columns: [{ key: 'name', label: 'Name' }, { key: 'pet_type', label: 'Pet Type' }, { key: 'breed', label: 'Breed' }, { key: 'owner_email', label: 'Owner Email' }, { key: 'user_id', label: 'Linked User' }, { key: 'availability_status', label: 'Availability' }],
    fields: [
      ...
      { name: 'status', label: 'Status', type: 'select', options: contentStatuses }, { name: 'user_id', label: 'Linked user ID' }, { name: 'owner_email', label: 'Owner email' }, { name: 'editable_by_user', label: 'Editable by user', type: 'checkbox' }, { name: 'meta_title', label: 'Meta title' }, { name: 'meta_description', label: 'Meta description', type: 'textarea' },
